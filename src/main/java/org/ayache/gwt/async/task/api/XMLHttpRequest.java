 ...
 */
class XMLHttpRequest extends JavaScriptObject {
   ...
   * null).
    ...
    this.open(httpMethod, url, async, user);
  }-*/;
     ...
     * >http://www.w3.org/TR/XMLHttpRequest/#the-responsetype-attribute</a>
     *
     * @param responseType the type of response desired. See
     * {@link ResponseType} for limitations on using the different values
     */
